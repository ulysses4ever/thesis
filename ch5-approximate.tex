...
\figref{figs:approx:eval} is derived from numbers produced by
running the tool implementing the algorithm without a types database (left
column of every pair of columns) and with the database (right column)
for each of the 10 packages. Every package name has the number of methods
inspected below it.
