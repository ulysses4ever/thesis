...
% \item
% Implementation. User's API (macro and otherwise)?
...
There are two subtle points of the algorithm: termination and enumeration of
...
\subsection{Enumeration of Concrete Input Types}%
\label{sec:enu}
