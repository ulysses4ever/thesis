...
% \end{lstlisting}
  ...
  discussed in \ssecref{ssec:perf} and \chapref{chap:jules}. In this case, the
...
% \end{minipage}
  ...
  \item In the running example and for the concrete input type \c{Array\{Float64, 1\}}
...
shown on Step 4 of the algorithm (\figref{fig:julia-type-infer}). But
