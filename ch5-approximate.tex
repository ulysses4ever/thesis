...
corner case 3 of \ssecref{ssect:uconstr-types}.
...
applied iteratively, as discussed in \ssecref{sec:approx:enu}, always only
...
\begin{itemize}
  \item
  The method is type stable if running Juila's type inference with declared
...
\chapref{chap:empirical}. The full list of packages is given in
