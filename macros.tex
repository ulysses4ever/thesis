...
\newcommand{\var}[1]{\EM{{\tinyb{\%}}\SF{#1}}}  %% variables start with a %
\newcommand{\tdef}[2]{\EM{#1\!::\!\SF{#2}}}     %% type definition have a ::
\newcommand{\val}{\EM{\SF{v}}}                  %% value
\newcommand{\tv}[2]{\EM{\tdef{\var{#1}}{#2}}}     %%  a typed variable
\newcommand{\ass}[2]{\EM{\var{#1} \leftarrow #2}} %%% assignment
...
\newcommand{\cond}[4]{\EM{\ass{#1}{\var{#2} ~?~ #3 : #4}}}  %%% conditional assignment
\newcommand{\get}[2]{\EM{\var{#1}[\SF{#2}]}}      %% field read
