...
\newcommand{\mySubtitle}{Simple and Efficient Optimization Technique}
...
assessment of type stability in the wild and proved correct a formal model of a JIT,
which performs the key Julia optimization (devirtualization) for type-stable code.
These results are published in OOPSLA
...
\secref{chap-problem} (Research Problem), namely, to devise an approach to
